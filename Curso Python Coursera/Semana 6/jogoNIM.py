...
Semana 6 - Programa Completo: Jogo NIM
...
def partida ():
    ...
    m = int(input("Limite de peças por jagada? "))
    parar = False
    vez = ""
    voce_ganhou = False
        ...
        while(parar == False):
            if vez == "PC":    
                ...
                if jogada_PC == 1:
                    ...
                    n = n - jogada_PC
                    print ("\nO computador tirou", jogada_PC, "peças.")
                    if n == 1:
                        print("\nAgora resta apenas uma peça no tabuleiro.")
                    elif n == 0:
                        print("\nFim do jogo! O computador ganhou!")
                ...
                sua_jogada = usuario_escolhe_jogada(n,m)
                vez = "PC"
                if sua_jogada == 1:
                    n = n - sua_jogada
                    print ("\nVocê tirou uma peça.")
...
def campeonato():
    ...
    print("Placar: Você", seus_pontos, "X", pontos_pc, "Computador")
